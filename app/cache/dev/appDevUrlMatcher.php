...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            if (0 === strpos($pathinfo, '/blog/listeArticle') && preg_match('#^/blog/listeArticle/(?P<nom>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sdzblog_listeArticle')), array (  '_controller' => 'Sdz\\BlogBundle\\Controller\\BlogController::listeArticleAction',));
            }
